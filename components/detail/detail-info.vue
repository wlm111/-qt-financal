		...
		<view class="common-list-r">
			<view>
				<view class="u-f-ac u-f-jsb">
					...
					class="icon iconfont icon-tianjia">关注</view>
				</view>
			...
			<view class="u-f-ac u-f-jsb">
				...
				<view class="u-f-ac">
					...
					{{item.sharenum}}</view>
					<view class="icon iconfont icon-tubiaozhizuo-">
					{{item.commentnum}}</view>
					<view class="icon iconfont icon-dianzan" @tap="caozuo('ding')">
					{{item.goodnum}}</view>
				</view>
			</view>
		</view>
