	...
	<view class="index-list animated fadeIn fast">
		<view class="index-list1 u-f-ac u-f-jsb">
			...
			<view class="u-f-ac" v-show="!item.isguanzhu" @tap="guanzhu">
				<view class="icon iconfont icon-tianjia"></view>关注
			</view>
		</view>
		...
		<view class="index-list4 u-f-ac u-f-jsb">
			<view class="u-f-ac">
				...
				@tap="caozuo('cai')">
					<view class="icon iconfont icon-cai"></view>
					{{item.infonum.cainum}}
				</view>
			</view>
			<view class="u-f-ac">
				<view class="u-f-ac">
					<view class="icon iconfont icon-tubiaozhizuo-"></view>
					{{item.commentnum}}
				</view>
				<view class="u-f-ac">
