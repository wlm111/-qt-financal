<template>
	<view>
		<!-- 状态栏 -->
		<uni-status-bar bgcolor="#3ff595"></uni-status-bar>
		<!-- 关闭按钮 -->
		...
		<view class="body">
			...
			<template v-else>
				<view class="login-input-box">
					...
					<input type="text" v-model="phone" class="uni-input common-input phone-input"
					placeholder="手机号" />
				</view>
				<view class="login-input-box">
		...
		@tap="changeStatus">
			{{status?'账号密码登录':'验证码登录'}}<view class="icon iconfont icon-right login-font-color"></view>
		</view>
		<!-- 第三方登陆 -->
