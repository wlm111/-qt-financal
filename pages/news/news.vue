		...
		@change="tabChange">
			...
			<swiper-item> 
				<scroll-view scroll-y class="list">
					...
					<!-- 热门分类 -->
					<post-nav :postnav="topic.postnav"></post-nav>
					<!-- 热门分类 -->
					<topic-nav :nav="topic.topicnav"></topic-nav>
					<!-- 最近更新 -->
...
<script>
	...
	import postNav from "../../components/news/post-nav.vue";
